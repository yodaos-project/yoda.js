...
function CronExpression (fields, options) {
  ...
  this._currentDate = new Date(options.currentDate.toISOString())
  this._endDate = options.endDate ? new Date(options.endDate.toISOString()) : null
  this._fields = {}
...
CronExpression.prototype.reset = function () {
  this._currentDate = new Date(this._options.currentDate.toISOString())
}
