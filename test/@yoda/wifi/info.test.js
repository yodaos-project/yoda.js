...
test('type check', function (t) {
  ...
  // Methods
  t.equal(typeof wifi.joinNetwork('***REMOVED***', '***REMOVED***'), 'number')
...
test('Check the return value of the function joinNetwork/useful data', (t) => {
  t.equal(wifi.joinNetwork('***REMOVED***', '***REMOVED***'), 0)
  t.end()
})

test('joinNetwork: illegal parameter', (t) => {
  t.plan(4)
  t.throws(() => { wifi.joinNetwork(null, '***REMOVED***') }, new RegExp('ssid must be a string'), 'The ssid is null')
  t.doesNotThrow(() => { wifi.joinNetwork('***REMOVED***', null) }, new RegExp('join network failed'), 'the passwords is null')

  t.throws(() => { wifi.joinNetwork(123456, '***REMOVED***') }, new RegExp('ssid must be a string'), 'The ssid is not a string but not null')
  t.throws(() => { wifi.joinNetwork('***REMOVED***', '1234567') }, new RegExp('join network failed'), 'The number of passwords is less than 7')
  t.end()
})
