...
inherits(TtsService, EventEmitter)

TtsService.prototype.speak = function (appId, text) {
...
TtsService.prototype.stop = function (appId, expectedReqId) {
  var appMemo = this.appRequestMemo[appId]
  if (appMemo == null) {
...
TtsService.prototype.pause = function (appId) {
  var appMemo = this.appRequestMemo[appId]
  if (appMemo == null) {
    logger.info(`app(${appId}) doesn't own any active requests`)
    return false
...
TtsService.prototype.resume = function (appId) {
  var appMemo = this.appRequestMemo[appId]
  if (appMemo == null) {
    logger.info(`app(${appId}) doesn't own any active requests`)
    return false
...
TtsService.prototype.clearMemo = function (appId, reqId) {
  delete this.requestMemo[reqId]
  delete this.appRequestMemo[appId]
}

TtsService.prototype.reset = function () {
...
TtsService.prototype.onStart = function onStart (reqId) {
...
TtsService.prototype.onTtsTermination = function onTtsTermination (event, reqId, errno) {
...
TtsService.prototype.connect = function connect (CONFIG) {
  if (this.config &&
